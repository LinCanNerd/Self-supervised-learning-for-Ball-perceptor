...
class BallPatchesDataset(Dataset):
    ...
    def showBall2(self, scale, bbx, image, minPixels = 5): #Testing function to make it the patch less random and have more overlapping with original image
